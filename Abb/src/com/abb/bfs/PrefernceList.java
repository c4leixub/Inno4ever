...
public class PrefernceList {
	public List<Integer> getPreference(List<List<Integer>> preferences) {
		...
		buildGraphAndGetIndegree(preferences, graph, indegree);
        topologicalSort(result, graph, indegree);
        
        return result;
	}
	
	private void topologicalSort(List<Integer> result, Map<Integer, Set<Integer>> graph,
	...
	private void buildGraphAndGetIndegree(List<List<Integer>> preferences,
